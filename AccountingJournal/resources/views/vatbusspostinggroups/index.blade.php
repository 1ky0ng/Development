                    ...
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                @foreach ($vatbusspostinggroups as $vatbusspostinggroup)
                                <tr>
                                    <td class="px-6 py-2 whitespace-nowrap text-xs font-bold">
                                        <a href="{{ route('vatbusspostinggroups.edit', ['vatbusspostinggroup' => $vatbusspostinggroup->code]) }}" class="text-indigo-600 hover:text-indigo-900">{{ $vatbusspostinggroup->code }}</a>
                                    </td>
                                    <td class="px-6 py-2 whitespace-nowrap text-xs text-gray-500">
                                        {{ $vatbusspostinggroup->description }}
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
