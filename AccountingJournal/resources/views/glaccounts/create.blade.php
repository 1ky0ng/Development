<x-app-layout>
    ...
    <x-slot name="actions">
        <button type="submit" name= "action" value="save" form="glaccounts.store" class="inline-flex items-center h-6 px-4 m-px text-sm transition-colors duration-150 rounded-sm focus:shadow-outline hover:bg-gray-200">
            Save</button>
        <button type="submit" name= "action" value="saveclose" form="glaccounts.store" class="inline-flex items-center h-6 px-4 m-px text-sm transition-colors duration-150 rounded-sm focus:shadow-outline hover:bg-gray-200">
            Save & Close</button>
        {{-- <a class="inline-flex items-center h-6 px-4 m-px text-sm transition-colors duration-150 rounded-sm focus:shadow-outline hover:bg-gray-200" 
            href="{{ route('glaccounts.create', ['glaccount' => $glaccount->no_]) }}">Refresh</a> --}}
        <a class="inline-flex items-center h-6 px-4 m-px text-sm transition-colors duration-150 rounded-sm focus:shadow-outline hover:bg-gray-200" 
    ...
    <div class="py-1">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-4 bg-white border-b border-gray-200">
                ...
                <form method="POST" id="glaccounts.store" action="{{ route('glaccounts.store', ['glaccount' => $glaccount]) }}"> 
                    {{-- @method('PUT') --}}
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-input id="no_" class="block mt-1 w-full text-xs" type="text" name="no_" value="{{ $glaccount->no_ }}" autofocus />
                        </div>
                    ...
                    {{-- <div class="flex items-center justify-end mt-4 hidden" id="submit-form">
                        <x-button class="ml-3">
                            {{ __('Save') }}
                        </x-button>
                    </div> --}}
