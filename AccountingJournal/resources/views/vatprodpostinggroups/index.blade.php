                    ...
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                @foreach ($vatprodpostinggroups as $vatprodpostinggroup)
                                <tr>
                                    <td class="px-6 py-2 whitespace-nowrap text-xs font-bold">
                                        <a href="{{ route('vatprodpostinggroups.edit', ['vatprodpostinggroup' => $vatprodpostinggroup->code]) }}" class="text-indigo-600 hover:text-indigo-900">{{ $vatprodpostinggroup->code }}</a>
                                    </td>
